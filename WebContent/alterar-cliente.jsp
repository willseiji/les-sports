		...
		<div class="row-fluid">
			<div class="span3" id="sidebar">
				<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
					...
					<li class="active"><a href="menu_dados_cliente.html"><i
							class="icon-chevron-right"></i> Cliente</a></li>
					<li class="active"><a href="menu_produto.jsp"><i
							class="icon-chevron-right"></i> Produto</a></li>
					<li class="active"><a href="menu_pedidos.html"><i
							class="icon-chevron-right"></i> Pedidos</a></li>
					<li class="active"><a href="menu_trocas.html"><i
							class="icon-chevron-right"></i> Trocas</a></li>
					<li class="active"><a href="menu_estoque.html"><i
							class="icon-chevron-right"></i> Estoque</a></li>
