                        ...
                        <!-- block -->
                                ...
                                <div class="span12" style="text-align: right">
                        			<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="myTable">
										...
										<tbody>
										<c:forEach var="itemProdutos" items="${listaProdutos}">
											<c:if test="${not empty itemProdutos}">
											<tr class="odd gradeX" onclick="myFunctionName(this)">
											<td style="display:none" id="id_produto">${itemProdutos[0]}</td>  
                                                <td><a style="text-decoration: underline">${itemProdutos[1]}</a></td>
												<td>${itemProdutos[2]}</td>
                                                <td>${itemProdutos[3]}</td>
												<td>${itemProdutos[4]}</td>
